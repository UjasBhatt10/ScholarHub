        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul id="bsb-tpl-navbar" class="navbar-nav justify-content-end flex-grow-1">
              <li class="nav-item">
                <a class="nav-link active" href="#scrollspyNav" aria-current="page" data-bs-dismiss="offcanvas"
                  data-bs-target="#offcanvasNavbar">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#scrollspyServices" data-bs-dismiss="offcanvas"
                  data-bs-target="#offcanvasNavbar">Benefits</a>
              </li>
              <!-- <li class="nav-item">
                <a class="nav-link" href="#scrollspyPortfolio" data-bs-dismiss="offcanvas"
                  data-bs-target="#offcanvasNavbar">Portfolio</a>
              </li> -->
              <!-- <li class="nav-item">
              ...
              <!-- <li class="nav-item">
                <a class="nav-link" href="#scrollspyPricing" data-bs-dismiss="offcanvas"
                  data-bs-target="#offcanvasNavbar">Schemes</a>
              </li> -->
              <!-- <li class="nav-item">
                <a class="nav-link" href="#scrollspyBlog" data-bs-dismiss="offcanvas"
                  data-bs-target="#offcanvasNavbar">Blog</a>
              </li> -->
              <!-- <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="login.php">Apply Now</a>
              </li>
    ...
    <div class="container overflow-hidden">
      <div class="row gy-3 gy-lg-0 align-items-lg-center justify-content-lg-between">
        <div class="col-12 col-lg-6 order-1 order-lg-0">
          <h1 class="display-3 fw-bolder mb-3">Free <br><mark class="bsb-tpl-highlight bsb-tpl-highlight-blue"><span
                class="bsb-tpl-font-hw display-2 text-accent fw-normal">Scholarship</span></mark> for every bright
            student</h1>
          <p class="fs-4 mb-5">Get free scholarships for every level of education that every student who achievement for
            a bright future you can get it from college</p>
          <div class="d-grid gap-2 d-sm-flex">
            <a href="login.php"><button type="button" class="btn btn-primary bsb-btn-3xl rounded-pill">Apply
                Now</button></a>
            <!-- <button type="button" class="btn btn-outline-primary bsb-btn-3xl rounded-pill">View Schemes</button> -->
          </div>
        </div>
        <div class="col-12 col-lg-5 text-center">
          <img class="img-fluid" loading="lazy" src="./assets/img/hero/scholarship.png" alt=""
      ...
      <div class="container mb-5 mb-md-6 mb-xl-10">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h2 class="display-3 fw-bolder mb-4">The <mark class="bsb-tpl-highlight bsb-tpl-highlight-yellow"><span
                  class="bsb-tpl-font-hw display-1 text-accent fw-normal">benefits</span></mark> that will get</h2>
            <p class="fs-6 mb-1">Have the opportunity to go to college without thinking about the cost? Just
              focus on studying and assignments given.</p>
          </div>
        </div>
      </div>
        ...
        <div class="row gy-5 gx-md-4 gy-lg-0 gx-xxl-5 justify-content-center">
          ...
          <div class="col-11 col-sm-6 col-lg-3">
            <div class="badge bsb-tpl-bg-green text-primary p-3 mb-4">
              <img src="./assets/img/beni/college.png" width="40" height="40" fill="currentColor"
            ...
            <h4 class="mb-3">Full college cost</h4>
            <p class="mb-3 text-secondary">Comprehensive fees for students during the course of study.</p>
          ...
          <div class="col-11 col-sm-6 col-lg-3">
            <div class="badge bsb-tpl-bg-yellow text-primary p-3 mb-4">
              <img src="./assets/img/beni/plane.png" width="40" height="40" fill="currentColor"
                class="bi bi-aspect-ratio" viewBox="0 0 16 16">
              <path
            ...
            <h4 class="mb-3">Transportation costs</h4>
            <p class="mb-3 text-secondary">The cost for each student's round trip from home to campus.
            </p>
            <a href="#!" class="fw-bold text-decoration-none link-primary">
              Learn More
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          ...
          <div class="col-11 col-sm-6 col-lg-3">
            <div class="badge bsb-tpl-bg-cyan text-primary p-3 mb-4">
              <img src="./assets/img/beni/book.png" width="40" height="40" fill="currentColor"
                class="bi bi-aspect-ratio" viewBox="0 0 16 16">
            ...
            <h4 class="mb-3">Learning equipment</h4>
            <p class="mb-3 text-secondary">All equipment to support learning activities for each student.</p>
            <a href="#!" class="fw-bold text-decoration-none link-primary">
              Learn More
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-arrow-right-short" viewBox="0 0 16 16">
        ...
        <div class="row gy-4 gy-lg-0 justify-content-xl-between">
          ...
          <div class="col-12 col-md-4 col-lg-3 col-xl-2">
            <div class="widget">
              ...
              <address class="mb-4">CHARUSAT Campus, Highway, Off, Nadiad - Petlad Rd, Changa, Gujarat 388421</address>
              <p class="mb-1">
                <a class="link-secondary text-decoration-none">02697 265 011</a>
              </p>
              <p class="mb-0">
                <a class="link-secondary text-decoration-none"
                  href="https://www.charusat.ac.in/">https://www.charusat.ac.in/</a>
              </p>
            </div>
          </div>
          <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          ...
          <div class="col-12 col-lg-3 col-xl-4">
            <div class="widget">
              ...
              <p class="mb-4">Subscribe to our newsletter to get our news & about new scholarships.</p>
              <form action="#!">
                <div class="row gy-4">
                  <div class="col-12">
        ...
        <div class="row gy-4 gy-md-0">
          <div class="col-xs-12 col-md-7 order-1 order-md-0">
            ...
            <div class="credits text-secondary text-center text-md-start mt-2 fs-7">
              Built by <a href="https://www.charusat.ac.in/" class="link-secondary text-decoration-none">CHARUSAT</a>
